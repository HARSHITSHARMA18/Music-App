    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 pt-36 relative">
      ...
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <button
            type="submit"
            className="px-6 py-2 rounded-lg bg-black-500 text-white font-medium hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
          >
            Send Message
          </button>
        </form>
